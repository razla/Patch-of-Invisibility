...
def main():
    parser = argparse.ArgumentParser(description='Pretrained gan_models loader')
    parser.add_argument('--gan_models', nargs='+', type=str,
    ...
    if args.out is None:
        args.out = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'gan_models')
