...
#     './gan_models/pretrained/deformators/SN_MNIST/',
#     G_weights='./gan_models/pretrained/generators/SN_MNIST/')

# deformator, G, shift_predictor = load_from_dir(
#     './gan_models/pretrained/deformators/SN_Anime/',
#     G_weights='./gan_models/pretrained/generators/SN_Anime/')

deformator, G, shift_predictor = load_from_dir(
    'gan_models/pretrained/deformators/BigGAN/',
    G_weights='./gan_models/pretrained/generators/BigGAN/G_ema.pth')

# deformator, G, shift_predictor = load_from_dir(
#     './gan_models/pretrained/deformators/ProgGAN/',
#     G_weights='./gan_models/pretrained/generators/ProgGAN/100_celeb_hq_network-snapshot-010403.pth')

# deformator, G, shift_predictor = load_from_dir(
#     './gan_models/pretrained/deformators/StyleGAN2/',
#     G_weights='./gan_models/pretrained/generators/StyleGAN2/stylegan2-ffhq-config-f.pt')
