...
from GANLatentDiscovery.gan_models.gan_load import make_big_gan, make_proggan, make_style_gan2, make_sngan, make_big_gan_D
...
def load_from_dir(root_dir, model_index=None, G_weights=None, shift_in_w=True):
    ...
    return deformator.eval(), G.eval().cuda(), shift_predictor.eval()
