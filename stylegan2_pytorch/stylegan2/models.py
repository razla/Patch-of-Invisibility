...
class _BaseModel(nn.Module):
    """
    Adds some base functionality to gan_models that inherit this class.
    """
...
# Base class for the parameterized gan_models. This is used as parent
...
# Base class for the synthesising and discriminating gan_models. This is used as parent
# class to reduce duplicate code and documentation for shared arguments.
